...
class ClaudeApiClient {
	constructor(apiKey) {
		this.apiKey = apiKey || process.env.CLAUDE_API
...
// Create singleton instance with API key from environment variable
const claudeClient = new ClaudeApiClient(process.env.CLAUDE_API)
